...
class ItemEncryptorASE {
    ...
    fun encrypt(plaintext: String, secret: String): String {
        ...
        return Base64.encodeToString(ciphertextAndNonceAndSalt, DEFAULT_BUFFER_SIZE)
    }

    fun decrypt(ciphertext: String, secret: String): String {

        //decode from base64
        val ciphertextAndNonceAndSalt: ByteArray = Base64.decode(ciphertext, DEFAULT_BUFFER_SIZE)
